...
class ToolSchemaTest {
    ...
    /**
     * Verifies that all tool classes in the adapters.mcp package
    ...
    void toolNamesAreUniqueAndMatchServerRegistration() throws Exception {
        // 1. Discover all *Tool classes in the adapters.mcp package
    ...
    /**
     * Discovers all *Tool classes in the io.github.deplague.jmcmcp.adapters.mcp
     * package by scanning the classpath for .class files.
     */
    ...
    /**
     * Counts CDI-discovered McpTools in adapters.mcp.
     */
    private int countRegisteredTools() throws Exception {
        return countCdiToolAdapters();
    }
