...
class GetJobStatusToolTest {
    ...
    void setUp() {
        ...
        GetJobStatusService getJobStatusService = new GetJobStatusService();
        GetJobStatusApplicationService appService = new GetJobStatusApplicationService(asyncJobService, getJobStatusService);
        tool = new GetJobStatusTool(appService);
    }
