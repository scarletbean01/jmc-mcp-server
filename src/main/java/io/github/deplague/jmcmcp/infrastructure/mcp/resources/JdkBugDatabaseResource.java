...
public final class JdkBugDatabaseResource {
    ...
    @Resource(uri = "mcp-jmc://database/jdk-bugs", name = "JDK Bug Database", description = "Reference list of known OpenJDK bugs affecting JFR metrics")
    public String getJdkBugs() {
        return """
