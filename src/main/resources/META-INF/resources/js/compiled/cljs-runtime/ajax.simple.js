...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__20251){
var map__20252 = p__20251;
var map__20252__$1 = cljs.core.__destructure_map(map__20252);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20252__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(request,new cljs.core.Keyword(null,"method","method",55703592),ajax.simple.normalize_method),new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951),(function (p1__20253_SHARP_){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__5142__auto__ = p1__20253_SHARP_;
 ...
 */
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__20257){
var map__20258 = p__20257;
var map__20258__$1 = cljs.core.__destructure_map(map__20258);
var request = map__20258__$1;
var interceptors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20258__$1,new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951));
...
var api = (function (){var or__5142__auto__ = new cljs.core.Keyword(null,"api","api",-899839580).cljs$core$IFn$_invoke$arity$1(request__$1);
if(cljs.core.truth_(or__5142__auto__)){
return or__5142__auto__;
} else {
