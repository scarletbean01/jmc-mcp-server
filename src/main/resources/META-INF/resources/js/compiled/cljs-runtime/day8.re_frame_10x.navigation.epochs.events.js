...
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("day8.re-frame-10x.navigation.epochs.events","scroll-into-view-debounced","day8.re-frame-10x.navigation.epochs.events/scroll-into-view-debounced",-416908306),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.trim_v], null),(function (_,p__23234){
var vec__23235 = p__23234;
var js_dom = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23235,(0),null);
...
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("day8.re-frame-10x.navigation.epochs.events","scroll-into-view","day8.re-frame-10x.navigation.epochs.events/scroll-into-view",-1183173127),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.trim_v], null),(function (_,p__23241){
var vec__23243 = p__23241;
var js_dom = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23243,(0),null);
...
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("day8.re-frame-10x.navigation.epochs.events","receive-new-traces","day8.re-frame-10x.navigation.epochs.events/receive-new-traces",542616228),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.trim_v], null),(function (p__23252,p__23253){
var map__23254 = p__23252;
var map__23254__$1 = cljs.core.__destructure_map(map__23254);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23254__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__23255 = p__23253;
var new_traces = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23255,(0),null);
var temp__5823__auto__ = cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"id","id",-1388402092),new_traces);
if(cljs.core.truth_(temp__5823__auto__)){
var sorted_traces = temp__5823__auto__;
...
var map__23260 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"settings","settings",1556144875),new cljs.core.Keyword(null,"low-level-trace","low-level-trace",638447092)], null));
var map__23260__$1 = cljs.core.__destructure_map(map__23260);
var drop_re_frame = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23260__$1,new cljs.core.Keyword(null,"re-frame","re-frame",-1039473033));
var drop_reagent = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23260__$1,new cljs.core.Keyword(null,"reagent","reagent",2131627322));
...
var finish_run = (function (){var or__5142__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.tools.metamorphic.finish_run_QMARK_,epoch_traces));
...
var end_of_match_QMARK_ = (function (){var or__5142__auto__ = cljs.core.seq(new_matches__$2);
if(or__5142__auto__){
return or__5142__auto__;
} else {
...
var retained_traces = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.drop_while.cljs$core$IFn$_invoke$arity$1((function (p1__23247_SHARP_){
return (new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__23247_SHARP_) < first_id_to_retain);
})),cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (trace){
var or__5142__auto__ = (cljs.core.truth_(drop_reagent)?day8.re_frame_10x.tools.metamorphic.low_level_reagent_trace_QMARK_(trace):null);
if(cljs.core.truth_(or__5142__auto__)){
return or__5142__auto__;
} else {
...
var select_latest_QMARK_ = (function (){var and__5140__auto__ = cljs.core.seq(new_matches__$2);
if(and__5140__auto__){
var or__5142__auto__ = cljs.core.empty_QMARK_(previous_matches);
if(or__5142__auto__){
return or__5142__auto__;
} else {
var G__23266 = new cljs.core.Keyword(null,"selected-epoch-id","selected-epoch-id",70601778).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"epochs","epochs",1796936425).cljs$core$IFn$_invoke$arity$1(db));
var fexpr__23265 = cljs.core.PersistentHashSet.createAsIfByAssoc([day8.re_frame_10x.navigation.epochs.events.first_match_id(cljs.core.last(previous_matches))]);
return (fexpr__23265.cljs$core$IFn$_invoke$arity$1 ? fexpr__23265.cljs$core$IFn$_invoke$arity$1(G__23266) : fexpr__23265.call(null,G__23266));
}
} else {
return and__5140__auto__;
}
})();
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"db","db",993250759),(function (){var G__23267 = cljs.core.update.cljs$core$IFn$_invoke$arity$variadic(cljs.core.assoc_in(db,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"traces","traces",-1301138004),new cljs.core.Keyword(null,"all","all",892129742)], null),retained_traces),new cljs.core.Keyword(null,"epochs","epochs",1796936425),cljs.core.assoc,new cljs.core.Keyword(null,"matches","matches",635497998),retained_matches,new cljs.core.Keyword(null,"match-ids","match-ids",752973161),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([match_ids,new cljs.core.Keyword(null,"matches-by-id","matches-by-id",1749529562),cljs.core.zipmap(match_ids,retained_matches),new cljs.core.Keyword(null,"parse-state","parse-state",-1931312535),parse_state__$2,new cljs.core.Keyword(null,"sub-state","sub-state",-2129237981),new_sub_state,new cljs.core.Keyword(null,"subscription-info","subscription-info",-1785424092),subscription_info], 0));
if(cljs.core.truth_(select_latest_QMARK_)){
return cljs.core.assoc_in(G__23267,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"epochs","epochs",1796936425),new cljs.core.Keyword(null,"selected-epoch-id","selected-epoch-id",70601778)], null),cljs.core.last(match_ids));
} else {
return G__23267;
}
...
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("day8.re-frame-10x.navigation.epochs.events","previous","day8.re-frame-10x.navigation.epochs.events/previous",2061328788),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"epochs","epochs",1796936425)], null)], 0))], null),(function (p__23271,_){
var map__23272 = p__23271;
var map__23272__$1 = cljs.core.__destructure_map(map__23272);
var map__23273 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23272__$1,new cljs.core.Keyword(null,"db","db",993250759));
var map__23273__$1 = cljs.core.__destructure_map(map__23273);
var db = map__23273__$1;
var match_ids = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23273__$1,new cljs.core.Keyword(null,"match-ids","match-ids",752973161));
var selected_epoch_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23273__$1,new cljs.core.Keyword(null,"selected-epoch-id","selected-epoch-id",70601778));
...
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("day8.re-frame-10x.navigation.epochs.events","next","day8.re-frame-10x.navigation.epochs.events/next",1388476595),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"epochs","epochs",1796936425)], null)], 0))], null),(function (p__23277,_){
var map__23278 = p__23277;
var map__23278__$1 = cljs.core.__destructure_map(map__23278);
var map__23279 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23278__$1,new cljs.core.Keyword(null,"db","db",993250759));
var map__23279__$1 = cljs.core.__destructure_map(map__23279);
var db = map__23279__$1;
var match_ids = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23279__$1,new cljs.core.Keyword(null,"match-ids","match-ids",752973161));
var selected_epoch_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23279__$1,new cljs.core.Keyword(null,"selected-epoch-id","selected-epoch-id",70601778));
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(selected_epoch_id,new_id)){
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"db","db",993250759),db], null);
} else {
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"db","db",993250759),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(db,new cljs.core.Keyword(null,"selected-epoch-id","selected-epoch-id",70601778),new_id),new cljs.core.Keyword(null,"dispatch","dispatch",1319337009),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.navigation.epochs.events","reset-current-epoch-app-db","day8.re-frame-10x.navigation.epochs.events/reset-current-epoch-app-db",1850636212),new_id], null)], null);
}
}));
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("day8.re-frame-10x.navigation.epochs.events","most-recent","day8.re-frame-10x.navigation.epochs.events/most-recent",-1146993774),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"epochs","epochs",1796936425)], null)], 0))], null),(function (p__23280,_){
var map__23281 = p__23280;
var map__23281__$1 = cljs.core.__destructure_map(map__23281);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23281__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("day8.re-frame-10x.navigation.epochs.events","load","day8.re-frame-10x.navigation.epochs.events/load",1738587584),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"epochs","epochs",1796936425)], null)], 0)),day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.trim_v], null),(function (p__23283,p__23284){
var map__23286 = p__23283;
var map__23286__$1 = cljs.core.__destructure_map(map__23286);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23286__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__23287 = p__23284;
var new_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23287,(0),null);
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"db","db",993250759),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(db,new cljs.core.Keyword(null,"selected-epoch-id","selected-epoch-id",70601778),new_id),new cljs.core.Keyword(null,"dispatch","dispatch",1319337009),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.navigation.epochs.events","reset-current-epoch-app-db","day8.re-frame-10x.navigation.epochs.events/reset-current-epoch-app-db",1850636212),new_id], null)], null);
}));
day8.re_frame_10x.navigation.epochs.events.replay_epochs = (function day8$re_frame_10x$navigation$epochs$events$replay_epochs(epochs){
var selected_epoch_id = (function (){var or__5142__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(epochs,new cljs.core.Keyword(null,"selected-epoch-id","selected-epoch-id",70601778));
if(cljs.core.truth_(or__5142__auto__)){
return or__5142__auto__;
} else {
...
if(cljs.core.truth_((function (){var and__5140__auto__ = (!((app_db_before == null)));
if(and__5140__auto__){
return event;
} else {
return and__5140__auto__;
...
return day8.re_frame_10x.navigation.epochs.events.replay_epochs(epochs);
}));
...
var temp__5827__auto__ = new cljs.core.Keyword(null,"replay","replay",-681122389).cljs$core$IFn$_invoke$arity$1(db);
if((temp__5827__auto__ == null)){
return db;
} else {
var event_to_replay = temp__5827__auto__;
...
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("day8.re-frame-10x.navigation.epochs.events","reset-current-epoch-app-db","day8.re-frame-10x.navigation.epochs.events/reset-current-epoch-app-db",1850636212),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.trim_v], null),(function (db,p__23299){
var vec__23300 = p__23299;
var new_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23300,(0),null);
...
var epochs_23354 = new cljs.core.Keyword(null,"epochs","epochs",1796936425).cljs$core$IFn$_invoke$arity$1(db);
var match_id_23355 = (function (){var or__5142__auto__ = new_id;
if(cljs.core.truth_(or__5142__auto__)){
return or__5142__auto__;
} else {
return day8.re_frame_10x.tools.coll.last_in_vec(cljs.core.get.cljs$core$IFn$_invoke$arity$2(epochs_23354,new cljs.core.Keyword(null,"match-ids","match-ids",752973161)));
}
})();
var match_23356 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(epochs_23354,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"matches-by-id","matches-by-id",1749529562),match_id_23355], null));
var event_23357 = day8.re_frame_10x.tools.metamorphic.matched_event(new cljs.core.Keyword(null,"match-info","match-info",666319879).cljs$core$IFn$_invoke$arity$1(match_23356));
var temp__5829__auto___23359 = day8.re_frame_10x.tools.metamorphic.app_db_after(event_23357);
if((temp__5829__auto___23359 == null)){
} else {
var new_db_23360 = temp__5829__auto___23359;
cljs.core.reset_BANG_(re_frame.db.app_db,new_db_23360);
}
} else {
}
...
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("day8.re-frame-10x.navigation.epochs.events","set-filter","day8.re-frame-10x.navigation.epochs.events/set-filter",1725152200),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"epochs","epochs",1796936425),new cljs.core.Keyword(null,"filter-str","filter-str",1974484789)], null)], 0)),day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.trim_v], null),(function (_,p__23309){
var vec__23310 = p__23309;
var filter_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23310,(0),null);
return filter_str;
}));
