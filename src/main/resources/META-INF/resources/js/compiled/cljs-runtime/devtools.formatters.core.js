...
var and__5140__auto__ = cljs.core.not(devtools.formatters.state.prevent_recursion_QMARK_());
if(and__5140__auto__){
var or__5142__auto__ = devtools.formatters.helpers.cljs_value_QMARK_(value);
...
var json_ml = ((devtools.formatters.templating.surrogate_QMARK_(value))?devtools.formatters.templating.render_markup(devtools.formatters.markup._LT_surrogate_header_GT_(value)):(((function (){try{if((!((value == null)))){
...
}catch (e20889){var _e__15075__auto__ = e20889;
return false;
}})())?devtools.format._header(value):(((function (){try{if((!((value == null)))){
...
}catch (e20891){var _e__15075__auto__ = e20891;
return false;
...
return cljs.core.boolean$(((devtools.formatters.templating.surrogate_QMARK_(value))?(!((devtools.formatters.templating.get_surrogate_body(value) == null))):(((function (){try{if((!((value == null)))){
if(((false) || ((cljs.core.PROTOCOL_SENTINEL === value.devtools$format$IDevtoolsFormat$)))){
return true;
} else {
if((!value.cljs$lang$protocol_mask$partition$)){
...
}catch (e20893){var _e__15075__auto__ = e20893;
return false;
}})())?devtools.format._has_body(value):(((function (){try{if((!((value == null)))){
if(((false) || ((cljs.core.PROTOCOL_SENTINEL === value.devtools$protocols$IFormat$)))){
return true;
} else {
if((!value.cljs$lang$protocol_mask$partition$)){
...
}catch (e20897){var _e__15075__auto__ = e20897;
return false;
...
}catch (e20899){var _e__15075__auto__ = e20899;
return false;
}})()){
...
}catch (e20901){var _e__15075__auto__ = e20901;
return false;
}})()){
...
var _STAR_current_state_STAR__orig_val__20903 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__20904 = (function (){var or__5142__auto__ = config;
if(cljs.core.truth_(or__5142__auto__)){
return or__5142__auto__;
} else {
...
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__20904);

try{return (raw_fn.cljs$core$IFn$_invoke$arity$1 ? raw_fn.cljs$core$IFn$_invoke$arity$1(value) : raw_fn.call(null,value));
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__20903);
}});
});
...
return (function() { 
var G__20918__delegate = function (args){
...
while (G__20919__i < G__20919__a.length) {G__20919__a[G__20919__i] = arguments[G__20919__i + 0]; ++G__20919__i;}
  args = new cljs.core.IndexedSeq(G__20919__a,0,null);
} 
return G__20918__delegate.call(this,args);};
G__20918.cljs$lang$maxFixedArity = 0;
G__20918.cljs$lang$applyTo = (function (arglist__20920){
var args = cljs.core.seq(arglist__20920);
return G__20918__delegate(args);
});
...
var pre_handler = (function (){var or__5142__auto__ = devtools.prefs.pref(pre_handler_key);
if(cljs.core.truth_(or__5142__auto__)){
return or__5142__auto__;
} else {
...
var post_handler = (function (){var or__5142__auto__ = devtools.prefs.pref(post_handler_key);
if(cljs.core.truth_(or__5142__auto__)){
return or__5142__auto__;
} else {
return cljs.core.identity;
