...
var m = (function (){var or__5142__auto__ = cljs.core.meta(expr);
...
var fm = (function (){var or__5142__auto__ = new cljs.core.Keyword("sci.impl","f-meta","sci.impl/f-meta",-1735495322).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(or__5142__auto__)){
return or__5142__auto__;
} else {
var G__32204 = f;
...
return cljs.core.meta(G__32204);
}
}
})();
...
var data__$1 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__32218,entry){
var vec__32219 = p__32218;
var acc = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32219,(0),null);
var last_file = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32219,(1),null);
var last_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32219,(2),null);
var last_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32219,(3),null);
var new_last_name = (function (){var or__5142__auto__ = new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(entry);
if(cljs.core.truth_(or__5142__auto__)){
return or__5142__auto__;
} else {
return last_name;
...
var new_last_file = (function (){var or__5142__auto__ = new cljs.core.Keyword(null,"file","file",-1269645878).cljs$core$IFn$_invoke$arity$1(entry);
if(cljs.core.truth_(or__5142__auto__)){
return or__5142__auto__;
} else {
return last_file;
...
var data = cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__32229){
var map__32230 = p__32229;
var map__32230__$1 = cljs.core.__destructure_map(map__32230);
var nom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32230__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32230__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32230__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32230__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32230__$1,new cljs.core.Keyword(null,"column","column",2078222095));
var built_in = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32230__$1,new cljs.core.Keyword("sci","built-in","sci/built-in",1244659599));
var local = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32230__$1,new cljs.core.Keyword(null,"local","local",-1497766724));
if(cljs.core.truth_((function (){var or__5142__auto__ = line;
if(cljs.core.truth_(or__5142__auto__)){
return or__5142__auto__;
} else {
return built_in;
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"name","name",1843675177),(""+cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(nom)?(""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(ns)+"/"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(nom)):ns))+cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(local)?(""+"#"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(local)):null))),new cljs.core.Keyword(null,"loc","loc",-584284901),(""+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__5142__auto__ = file;
if(cljs.core.truth_(or__5142__auto__)){
return or__5142__auto__;
} else {
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__32238){
var map__32239 = p__32238;
var map__32239__$1 = cljs.core.__destructure_map(map__32239);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32239__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var loc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32239__$1,new cljs.core.Keyword(null,"loc","loc",-584284901));
