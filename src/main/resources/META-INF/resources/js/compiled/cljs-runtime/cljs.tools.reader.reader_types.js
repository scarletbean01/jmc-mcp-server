...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_22700 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_22700(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_22702 = (function (reader){
var x__5498__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_22702(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_22703 = (function (reader,ch){
var x__5498__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_22703(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_22707 = (function (reader){
var x__5498__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_22707(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_22708 = (function (reader){
var x__5498__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_22708(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_22710 = (function (reader){
var x__5498__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_22710(reader);
}
});
...
var G__22755 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__22756 = s.append(c);
c = G__22755;
s = G__22756;
continue;
}
