...
var len__5876__auto___24844 = arguments.length;
var i__5877__auto___24845 = (0);
while(true){
if((i__5877__auto___24845 < len__5876__auto___24844)){
args_arr__5901__auto__.push((arguments[i__5877__auto___24845]));

var G__24846 = (i__5877__auto___24845 + (1));
i__5877__auto___24845 = G__24846;
continue;
} else {
}
break;
...
return zprint.hiccup.hiccup_color_str.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__5902__auto__);
...
/** @this {Function} */
(zprint.hiccup.hiccup_color_str.cljs$lang$applyTo = (function (seq24831){
var G__24832 = cljs.core.first(seq24831);
var seq24831__$1 = cljs.core.next(seq24831);
var self__5861__auto__ = this;
return self__5861__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24832,seq24831__$1);
}));
...
return (""+"<"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(first_sym)+cljs.core.str.cljs$core$IFn$_invoke$arity$1(((map_second_QMARK_)?(function (){var G__24842 = cljs.core.second(coll);
return (zprint.hiccup.hiccup__GT_html.cljs$core$IFn$_invoke$arity$1 ? zprint.hiccup.hiccup__GT_html.cljs$core$IFn$_invoke$arity$1(G__24842) : zprint.hiccup.hiccup__GT_html.call(null,G__24842));
})():""))+">"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(zprint.hiccup.hiccup__GT_html,rest_coll)))+"</"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(first_sym)+">");
} else {
if(cljs.core.map_QMARK_(coll)){
var pair = cljs.core.first(cljs.core.seq(coll));
return (""+" "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(cljs.core.first(pair)))+"=\""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.second(pair))+"\"");
} else {
return coll;
