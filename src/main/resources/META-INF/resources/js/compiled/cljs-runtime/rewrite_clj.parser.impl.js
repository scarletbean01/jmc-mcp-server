...
while(true){
var temp__5823__auto__ = rewrite_clj.reader.next(reader);
...
if((c === "\n")){
var G__26917 = escape_QMARK_;
var G__26918 = rewrite_clj.parser.impl.flush_into(lines,buf);
escape_QMARK_ = G__26917;
lines = G__26918;
continue;
} else {
buf.append(c);

var G__26919 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__26920 = lines;
escape_QMARK_ = G__26919;
lines = G__26920;
continue;
