...
var temp__5823__auto__ = cljs.core.deref(devtools.hints.processed_errors);
...
var reader = (function (){var or__5142__auto__ = devtools.prefs.pref(new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
return (""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(prefix)+" <<< \u2622 NULL \u2622 <<< "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(postfix));
});
...
var min_length = (function (){var or__5142__auto__ = devtools.prefs.pref(new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__5142__auto__)){
return or__5142__auto__;
} else {
return (128);
...
var map__16190 = top_item;
var map__16190__$1 = cljs.core.__destructure_map(map__16190);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16190__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16190__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16190__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e16188){var _e = e16188;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5823__auto___16226 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5823__auto___16226)){
var seen_errors_16227 = temp__5823__auto___16226;
if(cljs.core.truth_(seen_errors_16227.has(self))){
} else {
seen_errors_16227.add(self);

var temp__5825__auto___16228 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5825__auto___16228)){
var sense_16229 = temp__5825__auto___16228;
(self.message = (""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message)+", a sanity hint:\n"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_16229)));
} else {
}
}
} else {
...
var temp__5825__auto__ = devtools.hints.error_object_sense(error);
