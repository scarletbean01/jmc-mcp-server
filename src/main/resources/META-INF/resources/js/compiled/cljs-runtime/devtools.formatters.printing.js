...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__5883__auto__);
});
...
throw (new Error((""+"Assert failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1((""+"missing markup method in markup-db: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(fn_key)))+"\n"+"f")));
}
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq16236){
var G__16237 = cljs.core.first(seq16236);
var seq16236__$1 = cljs.core.next(seq16236);
var G__16238 = cljs.core.first(seq16236__$1);
var seq16236__$2 = cljs.core.next(seq16236__$1);
var self__5861__auto__ = this;
return self__5861__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16237,G__16238,seq16236__$2);
}));
...
if(cljs.core.truth_((function (){var or__5142__auto__ = devtools.formatters.helpers.directly_printable_QMARK_(value);
if(or__5142__auto__){
...
(devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__5434__auto__,writer__5435__auto__,opt__5436__auto__){
return cljs.core._write(writer__5435__auto__,"devtools.formatters.printing/TemplateWriter");
}));
...
var temp__5823__auto__ = cljs.core.first(cljs.core.first(group));
...
if(cljs.core.truth_((function (){var and__5140__auto__ = cljs.core.not(devtools.formatters.printing.already_reference_QMARK_(group));
if(and__5140__auto__){
var or__5142__auto__ = devtools.formatters.helpers.expandable_QMARK_(obj);
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__16263_SHARP_){
return (!((cljs.core.meta(p1__16263_SHARP_) == null)));
})))){
...
if(cljs.core.truth_((function (){var and__5140__auto__ = devtools.prefs.pref(new cljs.core.Keyword(null,"render-path-annotations","render-path-annotations",-1890931512));
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16287__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if((function (){var or__5142__auto__ = (function (){try{if((!((obj == null)))){
...
}catch (e16289){var _e__15075__auto__ = e16289;
return false;
}})();
if(or__5142__auto__){
return or__5142__auto__;
...
}catch (e16295){var _e__15075__auto__ = e16295;
return false;
}}
})()){
...
var temp__5823__auto__ = devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(markup_db,new cljs.core.Keyword(null,"atomic","atomic",-120459460),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([obj], 0));
if(cljs.core.truth_(temp__5823__auto__)){
...
var _STAR_current_state_STAR__orig_val__16300 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__16301 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__16301);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16302__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__16300);
}});
...
var temp__5823__auto___16378 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5823__auto___16378)){
var managed_print_level_16379 = temp__5823__auto___16378;
var _STAR_print_level_STAR__orig_val__16306_16380 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__16307_16381 = managed_print_level_16379;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__16307_16381);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__16305_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__16305_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__16306_16380);
}} else {
job_fn();
}
