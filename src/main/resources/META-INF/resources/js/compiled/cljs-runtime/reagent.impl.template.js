...
var G__21129 = o;
reagent.impl.template.goog$module$goog$object.set(G__21129,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__21147__delegate = function (args){
...
while (G__21148__i < G__21148__a.length) {G__21148__a[G__21148__i] = arguments[G__21148__i + 0]; ++G__21148__i;}
  args = new cljs.core.IndexedSeq(G__21148__a,0,null);
} 
return G__21147__delegate.call(this,args);};
G__21147.cljs$lang$maxFixedArity = 0;
G__21147.cljs$lang$applyTo = (function (arglist__21149){
var args = cljs.core.seq(arglist__21149);
return G__21147__delegate(args);
});
...
var G__21130 = o;
reagent.impl.template.goog$module$goog$object.set(G__21130,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__21150__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__21150 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__21151__i = 0, G__21151__a = new Array(arguments.length -  0);
while (G__21151__i < G__21151__a.length) {G__21151__a[G__21151__i] = arguments[G__21151__i + 0]; ++G__21151__i;}
  args = new cljs.core.IndexedSeq(G__21151__a,0,null);
} 
return G__21150__delegate.call(this,args);};
G__21150.cljs$lang$maxFixedArity = 0;
G__21150.cljs$lang$applyTo = (function (arglist__21152){
var args = cljs.core.seq(arglist__21152);
return G__21150__delegate(args);
});
...
var G__21131 = props;
var G__21131__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21131,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__21131);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21131__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5142__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__21132 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21132,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__21132;
}
})(),id_class);
...
var G__21133 = (cljs.core.count(argv) - first_child);
switch (G__21133) {
case (0):
...
var vec__21134 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21134,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21134,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21134,(2),null);
...
var temp__5829__auto___21156 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___21156 == null)){
} else {
var key_21157 = temp__5829__auto___21156;
(jsprops.key = key_21157);
}
...
var temp__5829__auto___21160 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___21160 == null)){
} else {
var key_21161 = temp__5829__auto___21160;
(jsprops.key = key_21161);
}
...
var temp__5829__auto___21164 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___21164 == null)){
} else {
var key_21165 = temp__5829__auto___21164;
(jsprops.key = key_21165);
}
...
var temp__5829__auto___21175 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___21175 == null)){
} else {
var key_21176 = temp__5829__auto___21175;
(jsprops.key = key_21176);
}
...
var temp__5829__auto___21178 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___21178 == null)){
} else {
var key_21179 = temp__5829__auto___21178;
(jsprops.key = key_21179);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21137_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__21137_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__21138 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21138,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21138,(1),null);
...
break;
default:
var G__21190 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__21191 = compiler;
v = G__21190;
compiler = G__21191;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template21144 = (function (opts,id,fn_to_element,parse_fn,meta21145){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template21144.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_21146,meta21145__$1){
var self__ = this;
var _21146__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template21144(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta21145__$1));
}));

(reagent.impl.template.t_reagent$impl$template21144.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_21146){
var self__ = this;
var _21146__$1 = this;
return self__.meta21145;
}));

(reagent.impl.template.t_reagent$impl$template21144.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template21144.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template21144.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template21144.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template21144.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template21144.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta21145","meta21145",-1667049649,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template21144.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template21144.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template21144");

(reagent.impl.template.t_reagent$impl$template21144.cljs$lang$ctorPrWriter = (function (this__5434__auto__,writer__5435__auto__,opt__5436__auto__){
return cljs.core._write(writer__5435__auto__,"reagent.impl.template/t_reagent$impl$template21144");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template21144.
 */
reagent.impl.template.__GT_t_reagent$impl$template21144 = (function reagent$impl$template$__GT_t_reagent$impl$template21144(opts,id,fn_to_element,parse_fn,meta21145){
return (new reagent.impl.template.t_reagent$impl$template21144(opts,id,fn_to_element,parse_fn,meta21145));
});
...
return (new reagent.impl.template.t_reagent$impl$template21144(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
