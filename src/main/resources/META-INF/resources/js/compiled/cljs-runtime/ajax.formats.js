...
var G__20222 = request;
var G__20223 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__20222,G__20223) : ajax.formats.get_format.call(null,G__20222,G__20223));
} else {
...
return cljs.core.some((function (p1__20234_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__20234_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__20236){
var map__20237 = p__20236;
var map__20237__$1 = cljs.core.__destructure_map(map__20237);
var request = map__20237__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20237__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__20240 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__20240.cljs$core$IFn$_invoke$arity$1 ? fexpr__20240.cljs$core$IFn$_invoke$arity$1(response) : fexpr__20240.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__20242){
var map__20243 = p__20242;
var map__20243__$1 = cljs.core.__destructure_map(map__20243);
var request = map__20243__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20243__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__20241_SHARP_){
return ajax.formats.get_accept_entries(request,p1__20241_SHARP_);
...
return ajax.interceptors.map__GT_ResponseFormat(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"read","read",1140058661),ajax.formats.detect_response_format_read(opts),new cljs.core.Keyword(null,"format","format",-1306924766),(""+"(from "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(accept)+")"),new cljs.core.Keyword(null,"content-type","content-type",-508222634),accept], null));
});
