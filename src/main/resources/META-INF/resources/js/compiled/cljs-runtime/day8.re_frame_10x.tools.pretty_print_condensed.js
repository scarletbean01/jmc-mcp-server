...
var day8$re_frame_10x$tools$pretty_print_condensed$ILimited$_limited_QMARK_$dyn_38194 = (function (x){
var x__5498__auto__ = (((x == null))?null:x);
var m__5499__auto__ = (day8.re_frame_10x.tools.pretty_print_condensed._limited_QMARK_[goog.typeOf(x__5498__auto__)]);
...
var m__5497__auto__ = (day8.re_frame_10x.tools.pretty_print_condensed._limited_QMARK_["_"]);
...
return day8$re_frame_10x$tools$pretty_print_condensed$ILimited$_limited_QMARK_$dyn_38194(x);
}
});
...
if((c > n)){
var G__38128 = cut_from;
var G__38128__$1 = (((G__38128 instanceof cljs.core.Keyword))?G__38128.fqn:null);
switch (G__38128__$1) {
case "start":
return (""+"\u2026"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.subs.cljs$core$IFn$_invoke$arity$3(string,(c - (n - (1))),c)));

break;
case "end":
return (""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.subs.cljs$core$IFn$_invoke$arity$3(string,(0),(n - (1))))+"\u2026");
...
break;
case (3):
return (""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.subs.cljs$core$IFn$_invoke$arity$3(string,(0),(1)))+"\u2026"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.subs.cljs$core$IFn$_invoke$arity$3(string,(c - (1)),c)));

break;
default:
var content_budget = (n - (2));
var per_side_budget = Math.floor((content_budget / (2)));
return (""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.subs.cljs$core$IFn$_invoke$arity$3(string,(0),(function (){var G__38132 = per_side_budget;
if(cljs.core.even_QMARK_(content_budget)){
return (G__38132 - (1));
} else {
return G__38132;
}
})()))+"..."+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.subs.cljs$core$IFn$_invoke$arity$3(string,(c - per_side_budget),c)));

}

break;
default:
throw (new Error((""+"No matching clause: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38128__$1))));
...
var G__38215 = clojure.string.replace(s,match,trunc_prefix);
var G__38216 = limit;
var G__38217 = match;
var G__38218 = trunc_prefix;
s = G__38215;
limit = G__38216;
match = G__38217;
trunc_prefix = G__38218;
continue;
}
}
break;
...
var prefix = (function (){var G__38139 = ((kw_QMARK_)?":":"");
if(cljs.core.truth_(the_ns)){
return (""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38139)+"\u2026/");
} else {
return G__38139;
}
})();
return (""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(prefix)+cljs.core.str.cljs$core$IFn$_invoke$arity$1(day8.re_frame_10x.tools.pretty_print_condensed.truncate_string.cljs$core$IFn$_invoke$arity$3((n - ((prefix).length)),new cljs.core.Keyword(null,"start","start",-355208981),the_name)));
} else {
var end = (""+"/"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(the_name));
...
return (""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(prefix)+cljs.core.str.cljs$core$IFn$_invoke$arity$1(ns_string)+cljs.core.str.cljs$core$IFn$_invoke$arity$1(end));
}
});
...
var vec__38159 = day8.re_frame_10x.tools.pretty_print_condensed.edges(coll);
var left = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38159,(0),null);
var right = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38159,(1),null);
return (""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(left)+cljs.core.str.cljs$core$IFn$_invoke$arity$1(value)+cljs.core.str.cljs$core$IFn$_invoke$arity$1(right));
});
/**
...
var or__5142__auto__ = (function (){var G__38168 = form.name;
if((G__38168 == null)){
return null;
} else {
return clojure.string.replace(G__38168,/(^.*\$)(.*)/,"$2");
}
})();
...
if(cljs.core.truth_((function (){var and__5140__auto__ = (enter_pred.cljs$core$IFn$_invoke$arity$1 ? enter_pred.cljs$core$IFn$_invoke$arity$1(form) : enter_pred.call(null,form));
...
var G__38171 = obj;
var G__38172 = writer;
var G__38173 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(opts,new cljs.core.Keyword(null,"fallback-impl","fallback-impl",-1501286995),day8.re_frame_10x.tools.pretty_print_condensed.pr_writer_impl);
return (alt_impl.cljs$core$IFn$_invoke$arity$3 ? alt_impl.cljs$core$IFn$_invoke$arity$3(G__38171,G__38172,G__38173) : alt_impl.call(null,G__38171,G__38172,G__38173));
} else {
...
var seq__38178 = cljs.core.seq(cljs.core.next(objs));
var chunk__38179 = null;
var count__38180 = (0);
var i__38181 = (0);
while(true){
if((i__38181 < count__38180)){
var obj = chunk__38179.cljs$core$IIndexed$_nth$arity$2(null,i__38181);
cljs.core._write(writer," ");

day8.re_frame_10x.tools.pretty_print_condensed.pr_writer(obj,writer,opts);


var G__38220 = seq__38178;
var G__38221 = chunk__38179;
var G__38222 = count__38180;
var G__38223 = (i__38181 + (1));
seq__38178 = G__38220;
chunk__38179 = G__38221;
count__38180 = G__38222;
i__38181 = G__38223;
continue;
} else {
var temp__5825__auto__ = cljs.core.seq(seq__38178);
if(temp__5825__auto__){
var seq__38178__$1 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__38178__$1)){
var c__5673__auto__ = cljs.core.chunk_first(seq__38178__$1);
var G__38224 = cljs.core.chunk_rest(seq__38178__$1);
var G__38225 = c__5673__auto__;
var G__38226 = cljs.core.count(c__5673__auto__);
var G__38227 = (0);
seq__38178 = G__38224;
chunk__38179 = G__38225;
count__38180 = G__38226;
i__38181 = G__38227;
continue;
} else {
var obj = cljs.core.first(seq__38178__$1);
cljs.core._write(writer," ");

day8.re_frame_10x.tools.pretty_print_condensed.pr_writer(obj,writer,opts);


var G__38228 = cljs.core.next(seq__38178__$1);
var G__38229 = null;
var G__38230 = (0);
var G__38231 = (0);
seq__38178 = G__38228;
chunk__38179 = G__38229;
count__38180 = G__38230;
i__38181 = G__38231;
continue;
}
} else {
...
(day8.re_frame_10x.tools.pretty_print_condensed.LimitedStringBufferWriter.cljs$lang$ctorPrWriter = (function (this__5434__auto__,writer__5435__auto__,opt__5436__auto__){
return cljs.core._write(writer__5435__auto__,"day8.re-frame-10x.tools.pretty-print-condensed/LimitedStringBufferWriter");
}));
...
var len__5876__auto___38237 = arguments.length;
var i__5877__auto___38238 = (0);
while(true){
if((i__5877__auto___38238 < len__5876__auto___38237)){
args__5882__auto__.push((arguments[i__5877__auto___38238]));

var G__38239 = (i__5877__auto___38238 + (1));
i__5877__auto___38238 = G__38239;
continue;
} else {
}
break;
...
return day8.re_frame_10x.tools.pretty_print_condensed.pr_str_truncated.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__5883__auto__);
});
...
/** @this {Function} */
(day8.re_frame_10x.tools.pretty_print_condensed.pr_str_truncated.cljs$lang$applyTo = (function (seq38191){
var G__38192 = cljs.core.first(seq38191);
var seq38191__$1 = cljs.core.next(seq38191);
var self__5861__auto__ = this;
return self__5861__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38192,seq38191__$1);
}));
