...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__21011 = c;
var G__21011__$1 = (((G__21011 == null))?null:G__21011.prototype);
if((G__21011__$1 == null)){
return null;
} else {
return G__21011__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__21014 = c;
var G__21014__$1 = (((G__21014 == null))?null:G__21014.prototype);
if((G__21014__$1 == null)){
return null;
} else {
return G__21014__$1.render;
}
})() == null)))));
});
...
var or__5142__auto__ = (function (){var G__21022 = c;
var G__21022__$1 = (((G__21022 == null))?null:G__21022.constructor);
if((G__21022__$1 == null)){
return null;
} else {
return G__21022__$1.displayName;
}
})();
...
var G__21023 = c;
var G__21023__$1 = (((G__21023 == null))?null:G__21023.constructor);
if((G__21023__$1 == null)){
return null;
} else {
return G__21023__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__21024 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__21025 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__21025);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__21024);
}});
...
var c = this;
var G__21064_21116 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__21064_21116 == null)){
} else {
reagent.ratom.dispose_BANG_(G__21064_21116);
}
...
var renders_21119 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_21120 = cljs.core.first(cljs.core.vals(renders_21119));
...
if((cljs.core.count(renders_21119) > (0))){
} else {
throw (new Error((""+"Assert failed: "+"Missing reagent-render"+"\n"+"(pos? (count renders))")));
}

if(((1) === cljs.core.count(renders_21119))){
} else {
throw (new Error((""+"Assert failed: "+"Too many render functions supplied"+"\n"+"(== 1 (count renders))")));
}

if(cljs.core.ifn_QMARK_(render_fun_21120)){
} else {
throw (new Error((""+"Assert failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1((""+"Expected something callable, not "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_21120], 0)))))+"\n"+"(clojure.core/ifn? render-fun)")));
}
...
var G__21099 = o;
reagent.impl.component.goog$module$goog$object.set(G__21099,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__21100 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__21101 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__21101);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__21100);
}});
...
var vec__21102 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21102,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21102,(1),null);
...
var G__21105 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__21105 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__21105);
}
});
}),[]);
