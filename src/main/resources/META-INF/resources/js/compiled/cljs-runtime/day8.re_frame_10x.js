...
if(cljs.core.truth_((function (){var and__5140__auto__ = cljs.core.deref(ready_to_bind_key);
...
if(cljs.core.truth_((function (){var and__5140__auto__ = cljs.core.deref(handle_keys_QMARK_);
if(cljs.core.truth_(and__5140__auto__)){
...
var width_PERCENT__20228 = ((new_window_width - x) / new_window_width);
if((width_PERCENT__20228 <= 0.9)){
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.settings.events","panel-width%","day8.re-frame-10x.panels.settings.events/panel-width%",-569115915),width_PERCENT__20228], null));
} else {
}
...
var left = (cljs.core.truth_(cljs.core.deref(showing_QMARK_))?(""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(((100) * ((1) - cljs.core.deref(panel_width_PERCENT_))))+"%"):(""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(window_width))+"px"));
...
var trace = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__20161_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(trace_id,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__20161_SHARP_));
...
var ignore = (function (p1__20195_SHARP_){
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"event-id","event-id",2130210178),p1__20195_SHARP_,new cljs.core.Keyword(null,"event-str","event-str",381347778),(""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__20195_SHARP_))], null);
});
var view = (function (p1__20196_SHARP_){
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ns","ns",441598760),p1__20196_SHARP_,new cljs.core.Keyword(null,"ns-str","ns-str",-2062616499),(""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__20196_SHARP_))], null);
});
var alias = (function (p__20206){
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,keep_vals,new cljs.core.PersistentArrayMap(null, 8, [new cljs.core.Keyword(null,"debug?","debug?",-1831756173),day8.re_frame_10x.debug_QMARK_,new cljs.core.Keyword(null,"retained-epochs","retained-epochs",1350238734),day8.re_frame_10x.history_size,new cljs.core.Keyword(null,"ignored-events","ignored-events",1738756589),(function (){var G__20212 = day8.re_frame_10x.ignored_events;
var G__20212__$1 = (((G__20212 == null))?null:(read.cljs$core$IFn$_invoke$arity$1 ? read.cljs$core$IFn$_invoke$arity$1(G__20212) : read.call(null,G__20212)));
var G__20212__$2 = (((G__20212__$1 == null))?null:cljs.core.map.cljs$core$IFn$_invoke$arity$2(ignore,G__20212__$1));
if((G__20212__$2 == null)){
return null;
} else {
return day8.re_frame_10x.tools.coll.sortable_uuid_map(G__20212__$2);
}
})(),new cljs.core.Keyword(null,"filtered-view-trace","filtered-view-trace",-901876599),(function (){var G__20214 = day8.re_frame_10x.hidden_namespaces;
var G__20214__$1 = (((G__20214 == null))?null:(read.cljs$core$IFn$_invoke$arity$1 ? read.cljs$core$IFn$_invoke$arity$1(G__20214) : read.call(null,G__20214)));
var G__20214__$2 = (((G__20214__$1 == null))?null:cljs.core.map.cljs$core$IFn$_invoke$arity$2(view,G__20214__$1));
if((G__20214__$2 == null)){
return null;
} else {
return day8.re_frame_10x.tools.coll.sortable_uuid_map(G__20214__$2);
}
})(),new cljs.core.Keyword(null,"app-db-follows-events?","app-db-follows-events?",-1566738462),day8.re_frame_10x.time_travel_QMARK_,new cljs.core.Keyword(null,"low-level-trace","low-level-trace",638447092),(function (){var G__20217 = day8.re_frame_10x.ignored_libs;
var G__20217__$1 = (((G__20217 == null))?null:(read.cljs$core$IFn$_invoke$arity$1 ? read.cljs$core$IFn$_invoke$arity$1(G__20217) : read.call(null,G__20217)));
if((G__20217__$1 == null)){
return null;
} else {
return day8.re_frame_10x.tools.coll.pred_map(G__20217__$1,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"re-frame","re-frame",-1039473033),null,new cljs.core.Keyword(null,"reagent","reagent",2131627322),null], null), null));
}
})(),new cljs.core.Keyword(null,"ns-aliases","ns-aliases",1290254821),(function (){var G__20218 = day8.re_frame_10x.ns_aliases;
var G__20218__$1 = (((G__20218 == null))?null:(read.cljs$core$IFn$_invoke$arity$1 ? read.cljs$core$IFn$_invoke$arity$1(G__20218) : read.call(null,G__20218)));
var G__20218__$2 = (((G__20218__$1 == null))?null:cljs.core.map.cljs$core$IFn$_invoke$arity$2(alias,G__20218__$1));
if((G__20218__$2 == null)){
return null;
} else {
return day8.re_frame_10x.tools.coll.sortable_uuid_map(G__20218__$2);
}
})(),new cljs.core.Keyword(null,"trace-when","trace-when",-1902271347),(function (){var G__20219 = day8.re_frame_10x.trace_when;
var G__20219__$1 = (((G__20219 == null))?null:(read.cljs$core$IFn$_invoke$arity$1 ? read.cljs$core$IFn$_invoke$arity$1(G__20219) : read.call(null,G__20219)));
if((G__20219__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__20219__$1);
}
})()], null));
})();
