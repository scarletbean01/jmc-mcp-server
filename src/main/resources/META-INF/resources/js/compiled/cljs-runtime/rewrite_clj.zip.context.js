...
return rewrite_clj.zip.walk.postwalk.cljs$core$IFn$_invoke$arity$3(zloc,(function (p1__30348_SHARP_){
var G__30349 = rewrite_clj.custom_zipper.core.node(p1__30348_SHARP_);
if((!((G__30349 == null)))){
if(((false) || ((cljs.core.PROTOCOL_SENTINEL === G__30349.rewrite_clj$node$protocols$MapQualifiable$)))){
return true;
} else {
if((!G__30349.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_(rewrite_clj.node.protocols.MapQualifiable,G__30349);
} else {
return false;
}
}
...
var nsmap = (cljs.core.truth_((function (){var and__5140__auto__ = parent;
...
if(cljs.core.truth_((function (){var and__5140__auto__ = nsmap;
if(cljs.core.truth_(and__5140__auto__)){
