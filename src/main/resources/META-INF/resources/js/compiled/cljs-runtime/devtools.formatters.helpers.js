...
var G__16230 = devtools.prefs.pref(v);
v = G__16230;
continue;
} else {
return v;
...
var and__5140__auto__ = cljs.core.not(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__5140__auto__){
var and__5140__auto____$1 = (!(cljs.core.var_QMARK_(value)));
...
var or__5142__auto__ = (function (){try{if((!((value == null)))){
...
}catch (e16174){var _e__15075__auto__ = e16174;
return false;
}})();
if(or__5142__auto__){
return or__5142__auto__;
} else {
var or__5142__auto____$1 = (function (){try{if((!((value == null)))){
...
}catch (e16178){var _e__15075__auto__ = e16178;
return false;
}})();
...
}catch (e16181){var _e__15075__auto__ = e16181;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__5140__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__5140__auto__)){
var and__5140__auto____$1 = (!(devtools.formatters.helpers.is_prototype_QMARK_(f)));
if(and__5140__auto____$1){
...
var and__5140__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__5140__auto__)){
...
var or__5142__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_(value);
...
var and__5140__auto__ = (function (){var or__5142__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_(value);
if(cljs.core.truth_(or__5142__auto__)){
return or__5142__auto__;
} else {
...
var vec__16198 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16198,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16198,(1),null);
var fully_qualified_type_name = (""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(ns)+"/"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(name));
...
var and__5140__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_(value);
if(cljs.core.truth_(and__5140__auto__)){
...
return cljs.core.some((function (p1__16206_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__16206_SHARP_);
}),template);
});
...
return (""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(prefix)+cljs.core.str.cljs$core$IFn$_invoke$arity$1(marker)+cljs.core.str.cljs$core$IFn$_invoke$arity$1(postfix));
});
devtools.formatters.helpers.get_more_marker = (function devtools$formatters$helpers$get_more_marker(more_count){
return (""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"plus-symbol","plus-symbol",-1984915189)))+cljs.core.str.cljs$core$IFn$_invoke$arity$1(more_count)+cljs.core.str.cljs$core$IFn$_invoke$arity$1(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-symbol","more-symbol",-2139760242))));
});
...
return (""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(args_open_symbol)+cljs.core.str.cljs$core$IFn$_invoke$arity$1(arity)+cljs.core.str.cljs$core$IFn$_invoke$arity$1(args_close_symbol));
});
...
var temp__5823__auto__ = devtools.formatters.helpers.pref(pref_key);
if(cljs.core.truth_(temp__5823__auto__)){
