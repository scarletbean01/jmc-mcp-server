...
return cljs.core.boolean$((function (){var or__5142__auto__ = cljs.core.some(cljs.core.some_fn.cljs$core$IFn$_invoke$arity$3(cljs.core.nil_QMARK_,meta_merge.core.displace_QMARK_,meta_merge.core.replace_QMARK_),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [left,right], null));
...
if(cljs.core.truth_((function (){var and__5140__auto__ = meta_merge.core.displace_QMARK_(left);
...
if(cljs.core.truth_((function (){var and__5140__auto__ = meta_merge.core.replace_QMARK_(left);
if(cljs.core.truth_(and__5140__auto__)){
...
if(cljs.core.truth_((function (){var or__5142__auto__ = meta_merge.core.displace_QMARK_(left);
if(cljs.core.truth_(or__5142__auto__)){
return or__5142__auto__;
} else {
return meta_merge.core.replace_QMARK_(right);
...
if(cljs.core.truth_((function (){var or__5142__auto__ = meta_merge.core.replace_QMARK_(left);
if(cljs.core.truth_(or__5142__auto__)){
return or__5142__auto__;
} else {
return meta_merge.core.displace_QMARK_(right);
...
var len__5876__auto___20315 = arguments.length;
var i__5877__auto___20316 = (0);
while(true){
if((i__5877__auto___20316 < len__5876__auto___20315)){
args_arr__5901__auto__.push((arguments[i__5877__auto___20316]));

var G__20317 = (i__5877__auto___20316 + (1));
i__5877__auto___20316 = G__20317;
continue;
} else {
}
break;
...
return meta_merge.core.meta_merge.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__5902__auto__);
...
if(cljs.core.truth_((function (){var or__5142__auto__ = new cljs.core.Keyword(null,"prepend","prepend",342616040).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(left));
if(cljs.core.truth_(or__5142__auto__)){
return or__5142__auto__;
} else {
...
/** @this {Function} */
(meta_merge.core.meta_merge.cljs$lang$applyTo = (function (seq20290){
var G__20291 = cljs.core.first(seq20290);
var seq20290__$1 = cljs.core.next(seq20290);
var G__20292 = cljs.core.first(seq20290__$1);
var seq20290__$2 = cljs.core.next(seq20290__$1);
var self__5861__auto__ = this;
return self__5861__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20291,G__20292,seq20290__$2);
}));
