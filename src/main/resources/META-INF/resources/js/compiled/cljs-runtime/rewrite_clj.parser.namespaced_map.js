...
var or__5142__auto__ = rewrite_clj.reader.boundary_QMARK_(c);
if(or__5142__auto__){
...
var G__27172 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(nodes,n);
nodes = G__27172;
continue;
} else {
...
var vec__27162 = rewrite_clj.parser.namespaced_map.parse_to_next_elem(reader,read_next);
var whitespace_nodes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27162,(0),null);
var map_node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27162,(1),null);
