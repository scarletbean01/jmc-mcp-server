...
goog.history.Html5History.prototype.getToken = function() {
  if (this.useFragment_) {
    ...
    return this.transformer_ ? this.transformer_.retrieveToken(this.pathPrefix_, this.window_.location) : this.window_.location.pathname.slice(this.pathPrefix_.length);
  }
};
