...
var comma_27386 = rewrite_clj.node.whitespace.whitespace_nodes(", ");
var space_27387 = rewrite_clj.node.whitespace.whitespace_node(" ");
rewrite_clj.node.coercer.map__GT_children = (function rewrite_clj$node$coercer$map__GT_children(m){
return cljs.core.vec(cljs.core.drop_last.cljs$core$IFn$_invoke$arity$2(cljs.core.count(comma_27386),cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__27369){
var vec__27370 = p__27369;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27370,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27370,(1),null);
return cljs.core.list_STAR_.cljs$core$IFn$_invoke$arity$4(rewrite_clj.node.protocols.coerce(k),space_27387,rewrite_clj.node.protocols.coerce(v),comma_27386);
...
return rewrite_clj.node.coercer.node_with_meta((function (){var G__27376 = cljs.core.vec(rewrite_clj.node.whitespace.space_separated(cljs.core.map.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.coerce,sq)));
