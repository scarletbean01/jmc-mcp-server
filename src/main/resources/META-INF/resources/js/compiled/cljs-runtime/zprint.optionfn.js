...
var nl_count = (cljs.core.truth_((function (){var and__5140__auto__ = multi_arity_QMARK_;
if(and__5140__auto__){
var and__5140__auto____$1 = multi_arity_nl_QMARK_;
...
})())?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(1),(2)], null):(cljs.core.truth_((function (){var and__5140__auto__ = multi_arity_QMARK_;
if(and__5140__auto__){
...
var zloc_seq_nc = (function (){var G__34312 = cljs.core.identity;
var G__34313 = new cljs.core.Keyword(null,"zloc","zloc",-2123059767).cljs$core$IFn$_invoke$arity$1(opts);
var fexpr__34311 = new cljs.core.Keyword(null,"zmap-no-comment","zmap-no-comment",1484161325).cljs$core$IFn$_invoke$arity$1(zfn_map);
...
var meta_seq = (function (){var fexpr__34318 = new cljs.core.Keyword(null,"zmap-no-comment","zmap-no-comment",1484161325).cljs$core$IFn$_invoke$arity$1(zfn_map);
return (fexpr__34318.cljs$core$IFn$_invoke$arity$2 ? fexpr__34318.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,meta_zloc) : fexpr__34318.call(null,cljs.core.identity,meta_zloc));
})();
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"meta","meta",1499536964),(function (){var G__34323 = cljs.core.second(meta_seq);
var fexpr__34322 = new cljs.core.Keyword(null,"ztag","ztag",125694964).cljs$core$IFn$_invoke$arity$1(zfn_map);
return (fexpr__34322.cljs$core$IFn$_invoke$arity$1 ? fexpr__34322.cljs$core$IFn$_invoke$arity$1(G__34323) : fexpr__34322.call(null,G__34323));
})())){
return null;
} else {
...
return new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"list","list",765357683),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"option-fn","option-fn",-959705456),null], null),new cljs.core.Keyword(null,"new-zloc","new-zloc",-1166607007),new_zloc,new cljs.core.Keyword(null,"new-l-str","new-l-str",-1564907437),(""+"#"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(l_str))], null);
} else {
return null;
}
}));
...
var result = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__34434_SHARP_,p2__34433_SHARP_){
if(cljs.core.truth_(cljs.core.re_find(cljs.core.first(p2__34433_SHARP_),fn_str))){
return cljs.core.reduced(cljs.core.second(p2__34433_SHARP_));
} else {
return null;
}
}),null,rule_pairs);
...
var fn_str = (""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(fn_name));
var rule_pairs = cljs.core.partition.cljs$core$IFn$_invoke$arity$4((2),(2),cljs.core.repeat.cljs$core$IFn$_invoke$arity$1(null),rules_vec);
var result = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__34468_SHARP_,p2__34467_SHARP_){
var lhs = cljs.core.first(p2__34467_SHARP_);
...
return cljs.core.reduced(cljs.core.second(p2__34467_SHARP_));
} else {
return null;
}
} else {
if(cljs.core.truth_(cljs.core.re_find(cljs.core.first(p2__34467_SHARP_),fn_str))){
return cljs.core.reduced(cljs.core.second(p2__34467_SHARP_));
} else {
return null;
}
