...
(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__5434__auto__,writer__5435__auto__,opt__5436__auto__){
return cljs.core._write(writer__5435__auto__,"day8.re-frame-10x.inlined-deps.reagent.v1v2v0.reagent.impl.template/NativeWrapper");
}));
...
var temp__5827__auto__ = day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.cache_get(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.prop_name_cache,cljs.core.name(k));
...
var G__17731 = o;
day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.goog$module$goog$object.set(G__17731,day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.cached_prop_name(k),(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.convert_prop_value.call(null,v)));
...
if(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.util.named_QMARK_(k)){
var temp__5827__auto__ = day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.cache_get(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.custom_prop_name_cache,cljs.core.name(k));
if((temp__5827__auto__ == null)){
var v = day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.util.dash_to_prop_name(k);
...
var G__17734 = o;
day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.goog$module$goog$object.set(G__17734,day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.cached_custom_prop_name(k),day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__17907__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
return G__17907__delegate.call(this,args);};
...
return G__17907__delegate(args);
});
...
var G__17738 = props;
var G__17738__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__17738,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__17738);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__17738__$1,new cljs.core.Keyword(null,"class","class",-2030961996),day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5142__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.set_id_class((function (){var G__17739 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__17739,new cljs.core.Keyword(null,"class","class",-2030961996),day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__17739;
}
})(),id_class);
...
var G__17742 = (cljs.core.count(argv) - first_child);
switch (G__17742) {
case (0):
...
(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.HiccupTag.cljs$lang$ctorPrWriter = (function (this__5434__auto__,writer__5435__auto__,opt__5436__auto__){
return cljs.core._write(writer__5435__auto__,"day8.re-frame-10x.inlined-deps.reagent.v1v2v0.reagent.impl.template/HiccupTag");
}));
...
var vec__17753 = cljs.core.next(cljs.core.re_matches(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17753,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17753,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17753,(2),null);
var className__$1 = (((className == null))?null:clojure.string.replace(className,/\./," "));
if(cljs.core.truth_(tag)){
} else {
throw (new Error((""+"Assert failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1((""+"Invalid tag: '"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(hiccup_tag)+"'"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.component.comp_name())))+"\n"+"tag")));
}
...
var temp__5829__auto___17928 = day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___17928 == null)){
} else {
var key_17932 = temp__5829__auto___17928;
(jsprops.key = key_17932);
}
...
var temp__5829__auto___17938 = day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___17938 == null)){
} else {
var key_17939 = temp__5829__auto___17938;
(jsprops.key = key_17939);
}
...
var jsprops = (function (){var or__5142__auto__ = day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.convert_prop_value(((hasprops)?props:null));
if(cljs.core.truth_(or__5142__auto__)){
return or__5142__auto__;
} else {
return ({});
...
var temp__5829__auto___17944 = day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___17944 == null)){
} else {
var key_17946 = temp__5829__auto___17944;
(jsprops.key = key_17946);
}
...
var temp__5827__auto__ = day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.cache_get(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.tag_name_cache,x);
if((temp__5827__auto__ == null)){
...
var hasprops = (((props == null)) || (cljs.core.map_QMARK_(props)));
var jsprops = (function (){var or__5142__auto__ = day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.convert_props(((hasprops)?props:null),parsed);
if(cljs.core.truth_(or__5142__auto__)){
return or__5142__auto__;
} else {
return ({});
...
var temp__5829__auto___17965 = day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___17965 == null)){
} else {
var key_17968 = temp__5829__auto___17965;
(jsprops.key = key_17968);
}
...
var temp__5829__auto___17970 = day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___17970 == null)){
} else {
var key_17971 = temp__5829__auto___17970;
(jsprops.key = key_17971);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__17786_SHARP_){
return day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.protocols.as_element(compiler,p1__17786_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__17803 = day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.check_derefs((function (){
return day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17803,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17803,(1),null);
if(cljs.core.truth_(derefed)){
if(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.debug.has_console){
((day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.debug.tracking)?day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.debug.track_console:console).warn((""+"Warning: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.util.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(x,day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.component.comp_name(),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Reactive deref not supported in lazy seq, ","it should be wrapped in doall"], 0)))));
} else {
}
} else {
}
...
if(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.debug.has_console){
((day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.debug.tracking)?day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.debug.track_console:console).warn((""+"Warning: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.util.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(x,day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.component.comp_name(),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Every element in a seq should have a unique :key"], 0)))));
} else {
}
} else {
}
...
throw (new Error((""+"Assert failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.util.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(v,day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.component.comp_name(),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Invalid Hiccup tag"], 0)))+"\n"+"(= \">\" n)")));
}

break;
default:
var G__17980 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__17981 = compiler;
v = G__17980;
compiler = G__17981;
continue;
...
throw (new Error((""+"Assert failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.util.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(v,day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.component.comp_name(),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Hiccup form should not be empty"], 0)))+"\n"+"(pos? (count v))")));
}

var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(v,(0),null);
if(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.valid_tag_QMARK_(tag)){
} else {
throw (new Error((""+"Assert failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.util.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(v,day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.component.comp_name(),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Invalid Hiccup form"], 0)))+"\n"+"(valid-tag? tag)")));
}
...
*/
day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template17852 = (function (opts,id,fn_to_element,parse_fn,meta17853){
this.opts = opts;
this.id = id;
...
(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template17852.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_17854,meta17853__$1){
var self__ = this;
var _17854__$1 = this;
return (new day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template17852(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta17853__$1));
}));

(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template17852.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_17854){
var self__ = this;
var _17854__$1 = this;
return self__.meta17853;
}));

(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template17852.prototype.day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template17852.prototype.day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template17852.prototype.day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template17852.prototype.day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template17852.prototype.day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
...
(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template17852.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta17853","meta17853",1195669260,null)], null);
}));

(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template17852.cljs$lang$type = true);

(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template17852.cljs$lang$ctorStr = "day8.re-frame-10x.inlined-deps.reagent.v1v2v0.reagent.impl.template/t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template17852");

(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template17852.cljs$lang$ctorPrWriter = (function (this__5434__auto__,writer__5435__auto__,opt__5436__auto__){
return cljs.core._write(writer__5435__auto__,"day8.re-frame-10x.inlined-deps.reagent.v1v2v0.reagent.impl.template/t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template17852");
}));

/**
 * Positional factory function for day8.re-frame-10x.inlined-deps.reagent.v1v2v0.reagent.impl.template/t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template17852.
 */
day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.__GT_t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template17852 = (function day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template$__GT_t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template17852(opts,id,fn_to_element,parse_fn,meta17853){
return (new day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template17852(opts,id,fn_to_element,parse_fn,meta17853));
});
...
return (new day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template17852(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
