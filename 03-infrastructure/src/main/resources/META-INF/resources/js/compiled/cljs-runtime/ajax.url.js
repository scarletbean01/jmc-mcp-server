...
ajax.url.key_value_pair_to_str = (function ajax$url$key_value_pair_to_str(p__19882){
...
return (""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(ajax.url.key_encode(k))+"="+cljs.core.str.cljs$core$IFn$_invoke$arity$1((ajax.url.value_encode.cljs$core$IFn$_invoke$arity$1 ? ajax.url.value_encode.cljs$core$IFn$_invoke$arity$1(v) : ajax.url.value_encode.call(null,v))));
});
...
var vec_key_encode = (function (){var G__19886 = (function (){var or__5142__auto__ = vec_strategy;
...
break;
default:
throw (new Error((""+"No matching clause: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__19886__$1))));
 ...
 */
ajax.url.param_to_key_value_pairs = (function ajax$url$param_to_key_value_pairs(vec_key_transform,prefix,p__19887){
var vec__19888 = p__19887;
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19888,(0),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19888,(1),null);
var k1 = ajax.url.key_encode(key);
var new_key = (cljs.core.truth_(prefix)?(cljs.core.truth_(key)?(""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(prefix)+"["+cljs.core.str.cljs$core$IFn$_invoke$arity$1(k1)+"]"):prefix):k1);
...
(ajax.url.url_request_format.cljs$core$IFn$_invoke$arity$1 = (function (p__19893){
var map__19894 = p__19893;
var map__19894__$1 = cljs.core.__destructure_map(map__19894);
var vec_strategy = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19894__$1,new cljs.core.Keyword(null,"vec-strategy","vec-strategy",1843221372));
