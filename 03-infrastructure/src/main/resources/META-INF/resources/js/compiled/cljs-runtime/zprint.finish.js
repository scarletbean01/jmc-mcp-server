...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__24865_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__24865_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__24865_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__24866){
var vec__24867 = p__24866;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24867,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24867,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__24870,s,color,element,idx){
var map__24871 = p__24870;
var map__24871__$1 = cljs.core.__destructure_map(map__24871);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24871__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24871__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24871__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__24880 = (function (){var or__5142__auto__ = color;
...
var fexpr__24879 = (function (){var G__24883 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
:(cljs.core.truth_((function (){var and__5140__auto__ = focus;
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__24883) : style_map.call(null,G__24883));
})();
return (fexpr__24879.cljs$core$IFn$_invoke$arity$1 ? fexpr__24879.cljs$core$IFn$_invoke$arity$1(G__24880) : fexpr__24879.call(null,G__24880));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__24884){
var vec__24885 = p__24884;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24885,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24885,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24885,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__24889){
var vec__24890 = p__24889;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24890,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24890,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24890,(2),null);
...
if(doing_nil_QMARK_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),(function (){var or__5142__auto__ = last_elide;
if(cljs.core.truth_(or__5142__auto__)){
return or__5142__auto__;
} else {
...
var G__25092 = cljs.core.next(ssv);
var G__25093 = (this_ssv == null);
var G__25094 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__25095 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__25092;
doing_nil_QMARK_ = G__25093;
last_elide = G__25094;
out = G__25095;
continue;
}
...
var vec__24922 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24922,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24922,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24922,(2),null);
...
var G__25096 = cljs.core.next(remaining_cvec);
var G__25097 = new_idx;
var G__25098 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__25096;
idx = G__25097;
out = G__25098;
continue;
}
...
var G__25101 = cljs.core.next(ss_vec);
var G__25102 = ((same_style_QMARK_)?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.first(current))+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.first(ss))),cljs.core.second(current),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(current,(2))], null):new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(ss),cljs.core.second(ss),pos], null));
var G__25103 = (pos + cljs.core.count(cljs.core.first(ss)));
var G__25104 = ((((same_style_QMARK_) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(initial_pos,pos))))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.add_length(current)));
ss_vec = G__25101;
current = G__25102;
pos = G__25103;
out = G__25104;
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__24959,cursor_vec){
var vec__24960 = p__24959;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24960,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24960,(1),null);
var focus_vec = vec__24960;
...
var vec__24963 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24963,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24963,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(color_fn,p__24969){
var vec__24974 = p__24969;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24974,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24974,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__25006,existing_count){
var vec__25008 = p__25006;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25008,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25008,(1),null);
...
var s__$1 = (((cursor >= cljs.core.count(s)))?(""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)+" "):s);
var len = cljs.core.count(s__$1);
var cursor__$1 = cljs.core.min.cljs$core$IFn$_invoke$arity$2(zprint.finish.floor((0),(len - (1))),cursor);
return cljs.core.filterv((function (p1__24997_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__24997_SHARP_))));
...
var vec__25049 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25049,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25049,(1),null);
var cvec_element = vec__25049;
if((cvec_element == null)){
var G__25112 = cljs.core.next(cvec_nl);
var G__25113 = (idx + (1));
var G__25114 = start;
var G__25115 = out;
cvec_nl = G__25112;
...
if(cljs.core.truth_((function (){var and__5140__auto__ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(n,(1));
...
var G__25117 = cljs.core.next(cvec_nl);
var G__25118 = (idx + (1));
var G__25119 = idx;
var G__25120 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__25117;
idx = G__25118;
start = G__25119;
out = G__25120;
...
var G__25124 = cljs.core.next(cvec_nl);
var G__25125 = (idx + (1));
var G__25126 = (idx + (1));
var G__25127 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__25124;
idx = G__25125;
start = G__25126;
out = G__25127;
...
if(cljs.core.truth_((function (){var and__5140__auto__ = (n > (1));
if(and__5140__auto__){
var and__5140__auto____$1 = new cljs.core.Keyword(null,"b","b",1482224470).cljs$core$IFn$_invoke$arity$1(where);
...
var G__25131 = cljs.core.next(cvec_nl);
var G__25132 = (idx + (1));
var G__25133 = idx;
...
var G__25135 = cljs.core.next(cvec_nl);
var G__25136 = (idx + (1));
var G__25137 = start;
var G__25138 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__25135;
idx = G__25136;
start = G__25137;
out = G__25138;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__25053_SHARP_,p2__25052_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__25052_SHARP_)){
return cljs.core.reduced(p1__25053_SHARP_);
} else {
return (p1__25053_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__25062,p__25063){
var vec__25064 = p__25062;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25064,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25064,(1),null);
var vec__25067 = p__25063;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25067,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25067,(1),null);
...
throw (new Error((""+"Line selector '"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(line_selector)+"' must be a number or a vector!"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(line_selector))));
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__25086,cvec,focus_vec){
var map__25087 = p__25086;
var map__25087__$1 = cljs.core.__destructure_map(map__25087);
var options = map__25087__$1;
var map__25088 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25087__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__25088__$1 = cljs.core.__destructure_map(map__25088);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25088__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25088__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25088__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
if(cljs.core.truth_((function (){var or__5142__auto__ = lines;
if(cljs.core.truth_(or__5142__auto__)){
return or__5142__auto__;
} else {
var or__5142__auto____$1 = paths;
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__25081_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__25081_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
