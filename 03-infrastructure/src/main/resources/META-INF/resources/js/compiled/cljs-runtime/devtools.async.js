...
return cljs.core.not((function (){var and__5140__auto__ = devtools.async.goog$module$goog$labs$userAgent$browser.isChrome();
...
return (""+"cljs-devtools: the :async feature is no longer needed since Chrome "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(devtools.async.fixed_chrome_version_for_async)+", "+"see https://github.com/binaryage/cljs-devtools/issues/20");
});
...
var o__15057__auto___16189 = (function (){var o__15057__auto___16189 = (function (){var o__15057__auto___16189 = Promise;
return (o__15057__auto___16189["resolve"]).call(o__15057__auto___16189);
})();
return (o__15057__auto___16189["then"]).call(o__15057__auto___16189,callback);
})();
(o__15057__auto___16189["catch"]).call(o__15057__auto___16189,devtools.async.rethrow_outside_promise);
...
var G__16184_16207 = Error;
var target__15068__auto___16208 = G__16184_16207;
if(cljs.core.truth_(target__15068__auto___16208)){
} else {
throw (new Error((""+"Assert failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1((""+"unable to locate object path "+" in "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__16184_16207)))+"\n"+"target__15068__auto__")));
}

(target__15068__auto___16208["stackTraceLimit"] = Infinity);
