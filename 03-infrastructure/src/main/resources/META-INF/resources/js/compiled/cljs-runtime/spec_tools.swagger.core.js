...
spec_tools.swagger.core.accept_spec = (function (){var method_table__5747__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
...
spec_tools.swagger.core.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),(function (_,___$1,children,p__26631){
var map__26632 = p__26631;
var map__26632__$1 = cljs.core.__destructure_map(map__26632);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26632__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26632__$1,new cljs.core.Keyword(null,"in","in",-1531184865));
...
var vec__26637 = spec_tools.impl.extract_form(spec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26637,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26637,(1),null);
var swagger_meta = spec_tools.impl.unlift_keys(data,"swagger");
var or__5142__auto__ = new cljs.core.Keyword(null,"swagger","swagger",-79684232).cljs$core$IFn$_invoke$arity$1(data);
...
spec_tools.swagger.core.extract_parameter = (function (){var method_table__5747__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var prefer_table__5748__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var method_cache__5749__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__5750__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__5751__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__26650 = cljs.core.get_global_hierarchy;
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"in","in",-1531184865),"body",new cljs.core.Keyword(null,"name","name",1843675177),(function (){var or__5142__auto__ = spec_tools.impl.qualified_name(spec_tools.core.spec_name(spec));
if(cljs.core.truth_(or__5142__auto__)){
return or__5142__auto__;
} else {
return "body";
}
})(),new cljs.core.Keyword(null,"description","description",-1428560544),(function (){var or__5142__auto__ = spec_tools.core.spec_description(spec);
if(cljs.core.truth_(or__5142__auto__)){
return or__5142__auto__;
} else {
return "";
...
var map__26658 = spec_tools.swagger.core.transform.cljs$core$IFn$_invoke$arity$2(spec,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),in$,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"parameter","parameter",1978789597)], null));
var map__26658__$1 = cljs.core.__destructure_map(map__26658);
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26658__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26658__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__26662){
var vec__26663 = p__26662;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26663,(0),null);
var map__26666 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26663,(1),null);
var map__26666__$1 = cljs.core.__destructure_map(map__26666);
var schema = map__26666__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26666__$1,new cljs.core.Keyword(null,"type","type",1174270348));
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"in","in",-1531184865),cljs.core.name(in$),new cljs.core.Keyword(null,"name","name",1843675177),k,new cljs.core.Keyword(null,"description","description",-1428560544),(function (){var or__5142__auto__ = spec_tools.core.spec_description(spec);
if(cljs.core.truth_(or__5142__auto__)){
return or__5142__auto__;
} else {
return "";
...
spec_tools.swagger.core.expand = (function (){var method_table__5747__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var prefer_table__5748__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var method_cache__5749__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__5750__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__5751__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__26671 = cljs.core.get_global_hierarchy;
...
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"responses","responses",1257546453),cljs.core.into.cljs$core$IFn$_invoke$arity$2((function (){var or__5142__auto__ = new cljs.core.Keyword(null,"responses","responses",1257546453).cljs$core$IFn$_invoke$arity$1(acc);
if(cljs.core.truth_(or__5142__auto__)){
return or__5142__auto__;
} else {
return cljs.core.PersistentArrayMap.EMPTY;
}
})(),(function (){var iter__5628__auto__ = (function spec_tools$swagger$core$iter__26675(s__26676){
return (new cljs.core.LazySeq(null,(function (){
var s__26676__$1 = s__26676;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__26676__$1);
if(temp__5825__auto__){
var s__26676__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__26676__$2)){
var c__5626__auto__ = cljs.core.chunk_first(s__26676__$2);
var size__5627__auto__ = cljs.core.count(c__5626__auto__);
var b__26678 = cljs.core.chunk_buffer(size__5627__auto__);
if((function (){var i__26677 = (0);
while(true){
if((i__26677 < size__5627__auto__)){
var vec__26682 = cljs.core._nth(c__5626__auto__,i__26677);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26682,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26682,(1),null);
cljs.core.chunk_append(b__26678,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [status,(function (){var $ = response;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26678),spec_tools$swagger$core$iter__26675(cljs.core.chunk_rest(s__26676__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26678),null);
}
} else {
var vec__26685 = cljs.core.first(s__26676__$2);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26685,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26685,(1),null);
...
var $__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1($))?cljs.core.update.cljs$core$IFn$_invoke$arity$4($,new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.swagger.core.transform,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"schema","schema",-1582001791)], null)):$);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3($__$1,new cljs.core.Keyword(null,"description","description",-1428560544),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,""));
})()], null),spec_tools$swagger$core$iter__26675(cljs.core.rest(s__26676__$2)));
}
} else {
return null;
}
...
var old = (function (){var or__5142__auto__ = new cljs.core.Keyword(null,"parameters","parameters",-1229919748).cljs$core$IFn$_invoke$arity$1(acc);
if(cljs.core.truth_(or__5142__auto__)){
return or__5142__auto__;
} else {
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__26696){
var vec__26697 = p__26696;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26697,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26697,(1),null);
return spec_tools.swagger.core.extract_parameter.cljs$core$IFn$_invoke$arity$2(in$,spec);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([v], 0));
var merged = cljs.core.vec(cljs.core.reverse(cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__26700,p){
var vec__26701 = p__26700;
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26701,(0),null);
var cache = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26701,(1),null);
var acc__$1 = vec__26701;
