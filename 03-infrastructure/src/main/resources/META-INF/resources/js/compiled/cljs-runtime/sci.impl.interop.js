...
var args__$1 = args.map((function (p1__33478_SHARP_){
return sci.impl.types.eval(p1__33478_SHARP_,ctx,bindings);
}));
...
return Reflect.construct(constructor$,args.map((function (p1__33525_SHARP_){
return sci.impl.types.eval(p1__33525_SHARP_,ctx,bindings);
})));
});
sci.impl.interop.invoke_static_method = (function sci$impl$interop$invoke_static_method(ctx,bindings,class$,method,args){
return Reflect.apply(method,class$,args.map((function (p1__33588_SHARP_){
return sci.impl.types.eval(p1__33588_SHARP_,ctx,bindings);
})));
});
...
var or__5142__auto__ = (function (){var temp__5823__auto__ = cljs.core.namespace(sym);
...
var or__5142__auto____$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"imports","imports",-1249933394).cljs$core$IFn$_invoke$arity$1(env),sym);
...
var env = cljs.core.deref(new cljs.core.Keyword(null,"env","env",-1815813235).cljs$core$IFn$_invoke$arity$1(ctx));
var class__GT_opts = new cljs.core.Keyword(null,"class->opts","class->opts",2061906477).cljs$core$IFn$_invoke$arity$1(env);
var class_opts = (function (){var or__5142__auto__ = (function (){var temp__5823__auto__ = cljs.core.namespace(sym);
if(cljs.core.truth_(temp__5823__auto__)){
var ns_STAR_ = temp__5823__auto__;
if(("js" === ns_STAR_)){
...
if(cljs.core.truth_(temp__5823__auto__)){
var vec__33646 = temp__5823__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33646,(0),null);
