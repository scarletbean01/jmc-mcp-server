...
var G__33701 = rewrite_clj.zip.next(n);
loc = G__33701;
continue;
} else {
var G__33702 = rewrite_clj.zip.next(loc);
loc = G__33702;
continue;
}
} else {
var G__33703 = rewrite_clj.zip.next(loc);
loc = G__33703;
continue;
}
}
...
return rewrite_clj.zip.replace(zloc,rewrite_clj.zip.root(zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__33630 = zloc;
var G__33630__$1 = (((G__33630 == null))?null:rewrite_clj.zip.node(G__33630));
if((G__33630__$1 == null)){
return null;
} else {
return rewrite_clj.zip.of_node_STAR_.cljs$core$IFn$_invoke$arity$1(G__33630__$1);
}
})())));
});
/**
...
var G__33710 = rewrite_clj.zip.down(nloc);
nloc = G__33710;
continue;
}
break;
...
var G__33711 = rewrite_clj.zip.right(nloc);
var G__33712 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__33711;
out = G__33712;
continue;
} else {
...
var G__33727 = rewrite_clj.zip.right(replaced_loc);
var G__33728 = cljs.core.next(new_loc);
var G__33729 = replaced_loc;
nloc = G__33727;
new_loc = G__33728;
last_loc = G__33729;
continue;
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__33684_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.tag(p1__33684_SHARP_),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.sexpr(p1__33684_SHARP_),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
