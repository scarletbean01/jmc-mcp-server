...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__41283_SHARP_){
return ((day8.re_frame_10x.tools.metamorphic.request_animation_frame_QMARK_(p1__41283_SHARP_)) || (day8.re_frame_10x.tools.metamorphic.request_animation_frame_end_QMARK_(p1__41283_SHARP_)));
}),traces);
})], 0));
...
var len__5876__auto___41323 = arguments.length;
var i__5877__auto___41324 = (0);
while(true){
if((i__5877__auto___41324 < len__5876__auto___41323)){
args_arr__5901__auto__.push((arguments[i__5877__auto___41324]));

var G__41325 = (i__5877__auto___41324 + (1));
i__5877__auto___41324 = G__41325;
continue;
} else {
}
break;
...
return day8.re_frame_10x.panels.timing.subs._PLUS_nil.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__5902__auto__);
...
/** @this {Function} */
(day8.re_frame_10x.panels.timing.subs._PLUS_nil.cljs$lang$applyTo = (function (seq41303){
...
return self__5861__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41304,G__41305,seq41303__$2);
}));

(day8.re_frame_10x.panels.timing.subs._PLUS_nil.cljs$lang$maxFixedArity = (2));

day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("day8.re-frame-10x.panels.timing.subs","animation-frame-time","day8.re-frame-10x.panels.timing.subs/animation-frame-time",1191520772),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.timing.subs","animation-frame-traces","day8.re-frame-10x.panels.timing.subs/animation-frame-traces",-1778771106)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.traces.subs","filtered-by-epoch-always","day8.re-frame-10x.panels.traces.subs/filtered-by-epoch-always",-1807060768)], null),(function (p__41310,p__41311){
var vec__41312 = p__41310;
var af_start_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41312,(0),null);
var epoch_traces = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41312,(1),null);
var vec__41315 = p__41311;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41315,(0),null);
var frame_number = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41315,(1),null);
...
var vec__41318 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(frame_pairs,(frame_number - (1)));
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41318,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41318,(1),null);
...
var map__41321 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(match,new cljs.core.Keyword(null,"timing","timing",-1849225195));
var map__41321__$1 = cljs.core.__destructure_map(map__41321);
var event_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41321__$1,new cljs.core.Keyword("re-frame","event-time","re-frame/event-time",-1349372188));
var event_handler_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41321__$1,new cljs.core.Keyword("re-frame","event-handler-time","re-frame/event-handler-time",1278050644));
var event_dofx_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41321__$1,new cljs.core.Keyword("re-frame","event-dofx-time","re-frame/event-dofx-time",650880716));
var event_run_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41321__$1,new cljs.core.Keyword("re-frame","event-run-time","re-frame/event-run-time",1941554897));
