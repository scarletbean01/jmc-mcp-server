...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__20293 = cljs.core.second(format);
var G__20294 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__20293,G__20294) : ajax.easy.keyword_response_format_element.call(null,G__20293,G__20294));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
var G__20296 = format;
var G__20296__$1 = (((G__20296 instanceof cljs.core.Keyword))?G__20296.fqn:null);
switch (G__20296__$1) {
case "transit":
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__20301_SHARP_){
return ajax.easy.keyword_response_format_element(p1__20301_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__20303){
var map__20305 = p__20303;
var map__20305__$1 = cljs.core.__destructure_map(map__20305);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20305__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20305__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20305__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
var h = (function (){var or__5142__auto__ = handler;
...
var e = (function (){var or__5142__auto__ = error_handler;
if(cljs.core.truth_(or__5142__auto__)){
return or__5142__auto__;
} else {
...
return (function ajax$easy$transform_handler_$_easy_handler(p__20307){
var vec__20308 = p__20307;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20308,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20308,(1),null);
var fexpr__20311_20324 = (cljs.core.truth_(ok)?h:e);
(fexpr__20311_20324.cljs$core$IFn$_invoke$arity$1 ? fexpr__20311_20324.cljs$core$IFn$_invoke$arity$1(result) : fexpr__20311_20324.call(null,result));
 ...
 */
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__20312){
var map__20313 = p__20312;
var map__20313__$1 = cljs.core.__destructure_map(map__20313);
var opts = map__20313__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20313__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20313__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20313__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20313__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20313__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
var needs_format = (((body == null)) && (cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(method,"GET")));
var rf = (cljs.core.truth_((function (){var or__5142__auto__ = format;
if(cljs.core.truth_(or__5142__auto__)){
return or__5142__auto__;
} else {
return needs_format;
