...
var len__5876__auto___29200 = arguments.length;
var i__5877__auto___29201 = (0);
while(true){
if((i__5877__auto___29201 < len__5876__auto___29200)){
args__5882__auto__.push((arguments[i__5877__auto___29201]));

var G__29202 = (i__5877__auto___29201 + (1));
i__5877__auto___29201 = G__29202;
continue;
} else {
}
break;
...
return rewrite_clj.zip.findz.tag_predicate.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__5883__auto__);
});

(rewrite_clj.zip.findz.tag_predicate.cljs$core$IFn$_invoke$arity$variadic = (function (t,p__29081){
var vec__29083 = p__29081;
var additional = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29083,(0),null);
if(cljs.core.truth_(additional)){
return (function (node){
var and__5140__auto__ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(node),t);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__29077_SHARP_),t);
});
}
}));
...
/** @this {Function} */
(rewrite_clj.zip.findz.tag_predicate.cljs$lang$applyTo = (function (seq29078){
var G__29079 = cljs.core.first(seq29078);
var seq29078__$1 = cljs.core.next(seq29078);
var self__5861__auto__ = this;
return self__5861__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29079,seq29078__$1);
}));

rewrite_clj.zip.findz.position_in_range_QMARK_ = (function rewrite_clj$zip$findz$position_in_range_QMARK_(zloc,pos){
var vec__29097 = ((cljs.core.map_QMARK_(pos))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"row","row",-570139521).cljs$core$IFn$_invoke$arity$1(pos),new cljs.core.Keyword(null,"col","col",-1959363084).cljs$core$IFn$_invoke$arity$1(pos)], null):pos);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29097,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29097,(1),null);
if((((r <= (0))) || ((c <= (0))))){
...
var vec__29105 = rewrite_clj.custom_zipper.core.position_span(zloc);
var vec__29108 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29105,(0),null);
var zstart_row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29108,(0),null);
var zstart_col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29108,(1),null);
var vec__29111 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29105,(1),null);
var zend_row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29111,(0),null);
var zend_col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29111,(1),null);
var and__5140__auto__ = (r >= zstart_row);
if(and__5140__auto__){
var and__5140__auto____$1 = (r <= zend_row);
if(and__5140__auto____$1){
var and__5140__auto____$2 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(r,zstart_row))?(c >= zstart_col):true);
...
return cljs.core.last(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__29131_SHARP_){
var and__5140__auto__ = (p_QMARK_.cljs$core$IFn$_invoke$arity$1 ? p_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__29131_SHARP_) : p_QMARK_.call(null,p1__29131_SHARP_));
if(cljs.core.truth_(and__5140__auto__)){
return rewrite_clj.zip.findz.position_in_range_QMARK_(p1__29131_SHARP_,pos);
} else {
return and__5140__auto__;
}
...
var G__29152 = zloc;
var G__29152__$1 = (((G__29152 == null))?null:(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__29152) : f.call(null,G__29152)));
if((G__29152__$1 == null)){
return null;
} else {
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(G__29152__$1,f,p_QMARK_);
}
}));
...
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(zloc,f,(function (p1__29156_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__29156_SHARP_),t);
}));
}));
...
return rewrite_clj.zip.findz.find_last_by_pos.cljs$core$IFn$_invoke$arity$3(zloc,pos,(function (p1__29172_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__29172_SHARP_),t);
}));
});
/**
...
var p_QMARK_ = ((cljs.core.set_QMARK_(v))?cljs.core.comp.cljs$core$IFn$_invoke$arity$2(v,rewrite_clj.zip.base.sexpr):(function (p1__29185_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.sexpr(p1__29185_SHARP_),v);
}));
