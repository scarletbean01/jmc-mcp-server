...
return (""+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__18272 = cljs.core.instance_QMARK_;
var expr__18273 = reactive_val;
if(cljs.core.truth_((pred__18272.cljs$core$IFn$_invoke$arity$2 ? pred__18272.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.RAtom,expr__18273) : pred__18272.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.RAtom,expr__18273)))){
return "ra";
} else {
if(cljs.core.truth_((pred__18272.cljs$core$IFn$_invoke$arity$2 ? pred__18272.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.RCursor,expr__18273) : pred__18272.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.RCursor,expr__18273)))){
return "rc";
} else {
if(cljs.core.truth_((pred__18272.cljs$core$IFn$_invoke$arity$2 ? pred__18272.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.Reaction,expr__18273) : pred__18272.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.Reaction,expr__18273)))){
return "rx";
} else {
if(cljs.core.truth_((pred__18272.cljs$core$IFn$_invoke$arity$2 ? pred__18272.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.Track,expr__18273) : pred__18272.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.Track,expr__18273)))){
return "tr";
} else {
return "other";
}
