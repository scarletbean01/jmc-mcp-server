...
spec_tools.json_schema.accept_spec = (function (){var method_table__5747__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
...
var temp__5823__auto__ = (function (){var and__5140__auto__ = infer_titles_QMARK_(options);
...
var map__26564 = spec_tools.impl.parse_keys(spec_tools.impl.extract_form(spec));
var map__26564__$1 = cljs.core.__destructure_map(map__26564);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26564__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26564__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26564__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26564__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var map__26577 = spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$1(form);
var map__26577__$1 = cljs.core.__destructure_map(map__26577);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26577__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var G__26578 = type;
...
break;
default:
throw (new Error((""+"No matching clause: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26578__$1))));
...
var vec__26583 = spec_tools.impl.strip_fn_if_needed(spec);
var ___$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26583,(0),null);
var minimum = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26583,(1),null);
var maximum = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26583,(2),null);
var ___$4 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26583,(3),null);
...
var vec__26586 = spec_tools.impl.extract_form(spec);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26586,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26586,(1),null);
...
var extra_info = (function (){var G__26589 = cljs.core.select_keys(data,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"description","description",-1428560544)], null));
if(cljs.core.truth_((function (){var and__5140__auto__ = name;
if(cljs.core.truth_(and__5140__auto__)){
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26589,new cljs.core.Keyword(null,"title","title",636505583),spec_tools.impl.qualified_name(name));
} else {
return G__26589;
}
})();
var or__5142__auto__ = new cljs.core.Keyword(null,"json-schema","json-schema",389191695).cljs$core$IFn$_invoke$arity$1(data);
