...
return reagent.dom.render.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [frontend.views.layout.app_layout], null),root_el);
});
frontend.core.init = (function frontend$core$init(){
frontend.routes.start_BANG_();
