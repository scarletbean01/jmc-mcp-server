 ...
 */
@ApplicationScoped
public final class JfrAccessorRepositoryImpl implements JfrAccessorRepository {
    ...
    @Override
    public <T> IMemberAccessor<T, IItem> getAccessor(IType<?> type, String identifier) {
     ...
     */
    @Override
    public <T> Optional<T> getMember(IItem item, String identifier) {
     ...
     */
    @Override
    public <T> Optional<T> getQuantity(IItem item, String identifier) {
