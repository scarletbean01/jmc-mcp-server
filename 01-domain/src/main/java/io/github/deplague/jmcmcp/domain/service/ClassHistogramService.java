...
public final class ClassHistogramService {
    ...
    private void processAllocations(IItemCollection events, String typeId, Map<String, ClassAllocStats> stats) {
        ...
        for (IItemIterable iterable : filtered) {
            ...
            IMemberAccessor<Object, IItem> classAccessor = jfrAccessorRepository.getAccessor(type1, "objectClass");
            IType<?> type = iterable.getType();
            IMemberAccessor<IQuantity, IItem> allocAccessor = jfrAccessorRepository.getAccessor(type, "allocationSize");
