    ...
    public BlockingSummaryResult analyze(IItemCollection events, int topN) {
        ...
        for (Entry<String, String> entry : eventToCategory.entrySet()) {
            ...
            for (IItemIterable iterable : filteredEvents) {
                ...
                IMemberAccessor<Object, IItem> threadAccessor = jfrAccessorRepository.getAccessor(type4, "eventThread");
                IMemberAccessor<IQuantity, IItem> durationAccessor = DURATION.getAccessor(iterable.getType());
                IType<?> type3 = iterable.getType();
                IMemberAccessor<Object, IItem> stackAccessor = jfrAccessorRepository.getAccessor(type3, "stackTrace");
                IType<?> type2 = iterable.getType();
                IMemberAccessor<Object, IItem> monitorClassAccessor = jfrAccessorRepository.getAccessor(type2, "monitorClass");
                IType<?> type1 = iterable.getType();
                IMemberAccessor<String, IItem> filePathAccessor = jfrAccessorRepository.getAccessor(type1, "path");
                IType<?> type = iterable.getType();
                IMemberAccessor<String, IItem> hostAccessor = jfrAccessorRepository.getAccessor(type, "host");
